export function createWelcomeEmailTemplate(name, profileUrl) {
  ...
  <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background: linear-gradient(to right, #0077B5, #00A0DC); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
      <img src="https://img.freepik.com/premium-vector/linkedin-logo_578229-227.jpg" alt="CareerNest Logo" style="width: 150px; margin-bottom: 20px;border-radius: 10px;">
    ...
    <div style="background-color: #ffffff; padding: 30px; border-radius: 0 0 10px 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
      ...
      <p>We're thrilled to have you join our professional community! CareerNest is your platform to connect, learn, and grow in your career.</p>
      ...
      <p>Best regards,<br>The CareerNest Team</p>
    </div>
  </body>
  </html>
  `;
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: #ffffff; padding: 30px; border-radius: 0 0 10px 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
    ...
    <p>Great news! <strong>${recipientName}</strong> has accepted your connection request on CareerNest.</p>
    <div style="background-color: #f3f6f8; padding: 20px; border-radius: 8px; margin: 20px 0;">
